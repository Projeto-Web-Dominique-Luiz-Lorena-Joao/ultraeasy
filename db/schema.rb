...
ActiveRecord::Schema[8.0].define(version: 2025_10_22_211010) do
  ...
  create_table "doctor_companies", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "company_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["company_id"], name: "index_doctor_companies_on_company_id"
    t.index ["user_id"], name: "index_doctor_companies_on_user_id"
  end
  ...
  add_foreign_key "doctor_companies", "companies"
