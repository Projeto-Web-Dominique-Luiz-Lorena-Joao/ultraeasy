class SpecialitiesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @speciality.update(speciality_params)
        format.html { redirect_to @speciality, notice: "Speciality was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to specialities_path, notice: "Speciality was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def speciality_params
      params.expect(speciality: [ :name, :description ])
    end
end
